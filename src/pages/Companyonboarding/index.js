      ...
      <Column className="bg-white_A700 font-poppins mx-[auto] lg:pb-[213px] xl:pb-[243px] 2xl:pb-[274px] pb-[329px] w-[100%]">
        ...
        <Row className="items-center 2xl:ml-[100px] ml-[120px] lg:ml-[77px] xl:ml-[88px] lg:mr-[129px] xl:mr-[148px] 2xl:mr-[166px] mr-[200px] lg:mt-[36px] xl:mt-[42px] 2xl:mt-[47px] mt-[57px] w-[81%]">
          ...
          <Column className="items-center lg:ml-[228px] xl:ml-[261px] 2xl:ml-[294px] ml-[353px] w-[40%]">
            ...
            <Column className="bg-bluegray_101 lg:mt-[20px] xl:mt-[23px] 2xl:mt-[26px] mt-[32px] lg:p-[41px] xl:p-[47px] 2xl:p-[53px] p-[64px] shadow-bs w-[100%]">
              ...
              <Text className="font-normal lg:ml-[23px] xl:ml-[27px] 2xl:ml-[30px] ml-[37px] xl:mt-[3px] lg:mt-[3px] 2xl:mt-[4px] mt-[5px] not-italic xl:text-[10px] 2xl:text-[11px] text-[14px] lg:text-[9px] text-bluegray_900 w-[auto]">
              ...
              <Text className="font-medium mb-[1px] 2xl:ml-[106px] ml-[128px] lg:ml-[82px] xl:ml-[94px] mt-[10px] lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] text-[10px] lg:text-[6px] xl:text-[7px] 2xl:text-[8px] text-black_900_7f w-[auto]">
                ...
                <span className="text-bluegray_901 font-poppins">Log In</span>
              </Text>
            </Column>
          </Column>
        </Row>
